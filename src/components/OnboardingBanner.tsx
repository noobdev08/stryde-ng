  ...
  return (
    <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg md:rounded-xl p-3 sm:p-4 md:p-5 lg:p-6 mb-6">
      <div className="flex items-start gap-2 sm:gap-3">
        ...
        <div>
          <p className="text-xs sm:text-sm md:text-base font-bold text-white mb-0.5 sm:mb-1 inline-flex items-center gap-2">
            Welcome, {userName}! <Hand size={16} className="text-blue-400" />
          </p>
